...
All publicly available data in this repository originates from [Project Gutenberg](https://gutenberg.org/about/).

> **Important Notice**: Project Gutenberg eBooks may be freely used in the United States because most are not protected by U.S. copyright law. They may not be free of copyright in other countries. **Readers outside the United States must verify local copyright laws** before accessing, downloading, or redistributing eBooks.

We also include a number of copyrighted titles for which the copyright holders have granted **permission for unlimited non-commercial worldwide use**. For Project Gutenberg content, **no permission is required** for non-commercial use. Redistribution of such eBooks is permitted globally, with or without the Project Gutenberg trademark. Refer to their ["Small Print"](https://www.gutenberg.org/policy/license.html) for more details.

### ⚖️ Copyright Status of Philosophy Books

The copyright status of philosophical works varies based on:
- **Date of the author’s death** (typically public domain 70+ years after death)
- **Jurisdiction-specific copyright laws**
- **Edition type** (modern commentaries or translations may still be copyrighted)

Some works may be in the **public domain** while others require **clearance** for usage, particularly modern editions.

### 🕵️‍♂️ Verification in Progress

For the remaining unpublished data, we are actively:
- Verifying copyright status
- Obtaining usage permissions from rights holders

We will continue updating the dataset as permissions are confirmed.
...
If you have questions regarding the dataset or publication:
